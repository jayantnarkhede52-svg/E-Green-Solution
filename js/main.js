...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Automated responses for each question
    const responses = {
        cost: "💰 Cost depends on system size, roof area, and location. A typical 5kW residential system costs ₹3-4 lakhs before subsidies. Want a free quote?",
        savings: "📊 Most customers save 60-90% on summer bills and 40-70% annually. A 5kW system typically saves ₹50,000-80,000 yearly. You can use our Solar Calculator to get exact estimates for your home!",
        subsidy: "🎁 Yes! Residential systems get 40% subsidy from Maharashtra govt (MAHAIPL scheme). Plus capital subsidy, tax benefits under 80D, and just 5% GST. We handle all subsidy applications for you!",
        installation: "⏱️ Installation takes 2-5 days for typical rooftop systems. Total approval + installation is 3-4 weeks including net metering setup. We work fast without compromising on quality!"
    };
    ...
    if (chatBtn && chatWidget && chatClose) {
        ...
        questionBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                setTimeout(() => {
                    addChatMessage(responses[questionKey], 'bot');
                }, 500);
                
                // Optional: Hide questions after first answer, show different options
                if (!chatMessages.querySelector('.follow-up-shown')) {
                    setTimeout(() => {
                        addChatMessage("Need more info? Feel free to ask another question or chat with us via WhatsApp/Phone!", 'bot');
                        addFollowUpOptions();
                    }, 1500);
                }
            });
        ...
        function addFollowUpOptions() {
            ...
            followUpDiv.className = 'follow-up-shown';
